...
public enum PreferenceEntity {
    ...
    PreferenceEntity(Object value) {
        name = name();
        defaultValue = value;
    }

    PreferenceEntity(String name, Object value) {
        this.name = name;
        defaultValue = value;
    }
    ...
    public static class TypeMismatchException extends RuntimeException {
        ...
        public TypeMismatchException(PreferenceEntity data) {
            this(data, null);
        }

        public TypeMismatchException(PreferenceEntity data, Class expectedType) {
